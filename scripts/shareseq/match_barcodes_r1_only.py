...
# Match barcodes from SHARE-seq data (R1 only)
# Input: 
...
#     Read name has both the cell barcode ID and raw sequence appended
...
def main():
    ...
    # Prep stats counters
    bc_match_stats = [collections.defaultdict(int) for i in range(1)]
